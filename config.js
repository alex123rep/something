const config = {
  // ID's
  "owners": [685519321350668329, 514951951243411467], // Adding your ID here will give you access to dangerous commands like eval. Please be careful with who you add here! Eval can be used to modify the host machine.
